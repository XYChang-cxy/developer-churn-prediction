...
from churn_prediction.data_preprocess.get_balanced_integrated_data import getBanlancedDataAndSave
...
def main():
    ...
    data_dir = r'F:\MOOSE_cxy\developer_churn_prediction\churn_prediction\data_preprocess\data'
